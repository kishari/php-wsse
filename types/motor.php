 ...
 */
class motor extends SoapClient {
	/**
	...
	private static $classmap = array(
		...
		"vin" => "vin",
		"allowanceIdentified" => "allowanceIdentified",
		"bmCheckMsgListIdentified" => "bmCheckMsgListIdentified",
		"bmMessageList" => "bmMessageList",
		"bmMessage" => "bmMessage",
		"bonusMalusIdentified" => "bonusMalusIdentified",
		"calculationRequest" => "calculationRequest",
		"calculationResponse" => "calculationResponse",
		"mtplExtIdentified" => "mtplExtIdentified",
		"coverageIdentified" => "coverageIdentified",
		"coverageListIdentified" => "coverageListIdentified",
		"deductibleCodeIdentified" => "deductibleCodeIdentified",
		"detailedModelCodeIdentified" => "detailedModelCodeIdentified",
		"string1x70" => "string1x70",
		"engineIdentified" => "engineIdentified",
		"eurotaxIdentified" => "eurotaxIdentified",
		"extraEquipmentIdentified" => "extraEquipmentIdentified",
		"extraEquipmentListIdentified" => "extraEquipmentListIdentified",
		"financingIdentified" => "financingIdentified",
		"motorIdentified" => "motorIdentified",
		"proposalRequest" => "proposalRequest",
		"proposalResponse" => "proposalResponse",
		"protectionDeviceIdentified" => "protectionDeviceIdentified",
		"protectionDeviceListIdentified" => "protectionDeviceListIdentified",
		"protectionKeysCardsListIdentified" => "protectionKeysCardsListIdentified",
		"registrationNumberIdentified" => "registrationNumberIdentified",
		"vehicleTypeIdentified" => "vehicleTypeIdentified",
		"vehicleUsageIdentified" => "vehicleUsageIdentified",
		"vehicleVendorIdentified" => "vehicleVendorIdentified",
		"vinIdentified" => "vinIdentified",
	 ...
	 */
	public function __construct($wsdl="../wsdl/motor.wsdl", $options=array()) {
